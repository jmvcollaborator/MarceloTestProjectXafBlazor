...
using MarceloTestProjectXafBlazor.Blazor.Server.Services;

namespace MarceloTestProjectXafBlazor.Blazor.Server {
    public partial class MarceloTestProjectXafBlazorBlazorApplication : BlazorApplication {
        public MarceloTestProjectXafBlazorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void MarceloTestProjectXafBlazorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
